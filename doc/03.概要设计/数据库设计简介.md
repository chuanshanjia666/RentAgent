...
> 文档版本：v1.5（v1.5 修订日期：2026-09-18，viewing_appointment 增 active_slot 列、唯一键改 uk_active_slot，时段互斥只约束仍占时段的有效预约；v1.4 于 2026-09-17 同步 AI 去模拟化口径；见版本记录）
> 编写日期：2026-09-13（按课程进度计划，2026-09-15"概要设计说明以及数据库设计简介"节点交付评审）
> 编制：李天泽（文档 / 数据）　参与评审：项目组全体
> 关联文档：《需求分析矩阵》v1.1、《概要设计说明》v1.9、《需求跟踪矩阵》v1.1
