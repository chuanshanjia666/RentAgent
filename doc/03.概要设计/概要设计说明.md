...
> 关联文档：《02-项目最终确认书》v1.1、《03-需求分析矩阵》v1.1、《数据库设计简介》v1.0、《08-需求跟踪矩阵》v1.1
...
> 逐条 FR → 组件/表/接口的追溯在第四~六章内联标注，并与《数据库设计简介》第七章、《08-需求跟踪矩阵》保持同一编号体系。
...
*配套文档：《数据库设计简介》《02-项目最终确认书》《03-需求分析矩阵》《08-需求跟踪矩阵》*
